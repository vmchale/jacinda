...
\begin{frame}[fragile]
  ...
  \begin{enumerate}
    ...
    % Associate argument \verb|x| with some temporary when we enter the lambda's scope, then replace all subsequent \verb|x| with reads from the environment (generate temporary)
