...
/usr/lib/libSystem.B.dylib
      \end{verbatim}
      % fill second with spaces (enough for difference lol?)
    \item \hspace{0pt} \vtop{\halign {#\crcr \hfill \verb|$1 ~ /^name/| \hfill \crcr \noalign {\kern 3\dimen11 \nointerlineskip} \upbracefill \crcr \noalign {\kern 3\dimen11 \nointerlineskip} \crcr \noalign {\kern 3\dimen11\nointerlineskip} \small{Execute on these lines} \crcr\noalign{\kern 3\dimen11\nointerlineskip}}}
