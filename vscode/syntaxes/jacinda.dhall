...
in  { fileTypes = [ "jac" ]
    ...
    , patterns =
        map
          ...
          , TextMate.MatchRe
              { match =
                  "(splitc|sprintf|option|match|captures|fp|nf|rs|fs|ors|ofs|csv|asv|usv|ix|substr|split|min|max|Some|None|mapMaybe|dedup|filter|fold|fold1|scan|dedupOn|catMaybes|sub1|subs)"
